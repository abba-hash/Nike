...
const Hero = () => {
  ...
  return (
    ...
    gap-10 max-container '>
      ...
      justify-center items-start w-full max-xl:padding-x pt-28 flex-col">
      ...
      bg-primary bg-hero bg-cover bg-center'>
        <img className=' object-contain relative z-10' src={bigShoeImg} alt='hero image
        width={610}
        height={500} '/>

        <div className=' flex sm:gap-6 ga-4 
